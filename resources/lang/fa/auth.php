...
return [
    ...
    'you_must_verify_your_email'=>'ایمیل شما تایید نشده است لطفا برای استفاده از تمامی امکانات سایت ایمیل خود را تایید کنید. چناچه ایمیل تاییدیه
    را دریافت نکرده اید با کلیک برروی
    <a href=":link">این لینک</a>
    ایمیل تاییده برای شما ارسال خواهد شد.',
    'verification email sent'=>'ایمیل تاییده ارسال شد',
    'email has verify'=>'ایمیل شما با موفقیت تایید شد.'
